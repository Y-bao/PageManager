...
(function (global, factory) {
  ...
  var AnimClass = function () {
      function AnimClass() {
          classCallCheck(this, AnimClass);
      }

      createClass(AnimClass, [{
          key: "m",
          get: function get$$1() {
              return this._m;
          }
  ...
  var TransitionClass = function () {
      function TransitionClass(enter, leave) {
          classCallCheck(this, TransitionClass);
  ...
  var PageAnimation = function () {
      function PageAnimation(obj) {
          classCallCheck(this, PageAnimation);
      ...
      createClass(PageAnimation, [{
          ...
          key: "mergeOpenClass",
          value: function mergeOpenClass(p1, p2) {
              if (p1 && p2) {
                  return new TransitionClass(Object.assign(new AnimClass(), p1.openEnter, p2.openEnter), Object.assign(new AnimClass(), p1.openLeave, p2.openLeave));
              } else if (p1) {
          ...
          key: "mergeCloseClass",
          value: function mergeCloseClass(p1, p2) {
              if (p1 && p2) {
                  return new TransitionClass(Object.assign(new AnimClass(), p1.closeEnter, p2.closeEnter), Object.assign(new AnimClass(), p1.closeLeave, p2.closeLeave));
              } else if (p1) {
  ...
  var Page = function () {
      ...
      createClass(Page, [{
          key: "overridePageAnimation",
          value: function overridePageAnimation(obj) {
  ...
  var PageManager = function () {
      ...
      createClass(PageManager, [{
          ...
          key: "_beforeEachProxy",
          value: function _beforeEachProxy(to, from, next) {
              ...
              if (this._listenGuide != false) {
                  if (!to.query || !to.query.pageToken) {
                      ...
                      this._jumpWay = this._token > to.query.pageToken ? JumpWay.Prev : this._token == 0 ? JumpWay.Refresh : JumpWay.Next;
          ...
          key: "_addPages",
          value: function _addPages(routes) {
              var _this = this;
              ...
              routes.forEach(function (route) {
                  if (route.name) {
                      ...
                      Object.defineProperty(_this._pages, route.name, {
                          get: function get$$1() {
                              return page;
                          }
                      });
                  ...
                  if (route.children) {
                      _this._addPages(route.children);
                  }
              });
          }
      }, {
          key: "reCreateReplacePath",
          value: function reCreateReplacePath(_location) {
          ...
          key: "setTransitionClass",
          value: function setTransitionClass(to, from, routeClass, action) {
              var pageRoute;
              ...
              var transitionClass;
              var overrideAnim = page.overrideAnim;
              if (overrideAnim) {
                  if (this.jumpWay == JumpWay.Prev) {
                  ...
                  if (this.jumpWay == JumpWay.Prev) {
                      transitionClass = PageAnimation.mergeCloseClass(this.pageAnimation, pageAnimation);
                  } else if (this.jumpWay == JumpWay.Next) {
                      transitionClass = PageAnimation.mergeOpenClass(this.pageAnimation, pageAnimation);
                  }
              }
          ...
          key: "getPage",
          value: function getPage(pageRoute, routeClass) {
              if (pageRoute) {
                  if (routeClass) {
                      if (pageRoute.matched && pageRoute.matched.length >= routeClass) {
  ...
  var PMRouter = function (_Router) {
      inherits(PMRouter, _Router);

      function PMRouter(obj) {
          classCallCheck(this, PMRouter);

          var pageManager = new PageManager()._init(obj);

          var _this2 = possibleConstructorReturn(this, (PMRouter.__proto__ || Object.getPrototypeOf(PMRouter)).call(this, obj));

          _this2._pageManager = pageManager;

          //代理beforeEach
          get(PMRouter.prototype.__proto__ || Object.getPrototypeOf(PMRouter.prototype), "beforeEach", _this2).call(_this2, pageManager._beforeEachProxy.bind(pageManager));
          return _this2;
      }

      createClass(PMRouter, [{
          key: "addRoutes",
          value: function addRoutes(routes) {
              this.$pm._addPages(routes);
              get(PMRouter.prototype.__proto__ || Object.getPrototypeOf(PMRouter.prototype), "addRoutes", this).call(this, routes);
          }
      }, {
          key: "replace",
          value: function replace(_location, _onComplete, _onAbort) {
              get(PMRouter.prototype.__proto__ || Object.getPrototypeOf(PMRouter.prototype), "replace", this).call(this, this.$pm.reCreateReplacePath(_location), _onComplete, _onAbort);
          }
      }, {
          key: "beforeEach",
          ...
          value: function install(Vue, options) {
              ...
              Vue.mixin({
                  beforeCreate: function beforeCreate() {
                      var _t;
                      if ((_t = this.$options) && (_t = _t.router)) {
                          window._pageManager = _t.$pm;
                      }
                  }
              });
              Object.defineProperty(window, "$pm", {
                  get: function get$$1() {
                      return this._pageManager;
                  }
              });
